...
export function PlaceFilters({onFilter}: { onFilter: (f: Filters) => void }) {
    ...
    return (
        <div
            className="sticky top-20 z-30 bg-white/95 dark:bg-[#1a1a1a]/95 backdrop-blur-sm border-b border-[#dddddd] dark:border-[#3a3a3a] py-4 mb-8">
            <div className="space-y-4">

                {/* ── Pill search bar ─────────────────────────────────── */}
                <div
                    className="flex items-center h-16 bg-white dark:bg-[#222222] border border-[#dddddd] dark:border-[#3a3a3a] rounded-full shadow-tier max-w-2xl">
              ...
              <span className="text-[11px] font-semibold text-[#222222] dark:text-[#f0f0f0] uppercase tracking-wider mb-0.5 text-left select-none">
                ...
                {typeLabel}
                        ...
                        {typeOpen && (
                            <div
                                className="absolute top-full left-0 mt-4 w-64 bg-white dark:bg-[#222222] rounded-[14px] border border-[#dddddd] dark:border-[#3a3a3a] shadow-tier py-2 z-50">
                ...
                <div className="flex items-center gap-3 flex-wrap">
                  ...
                  {advCount}
                        ...
                        {advOpen && (
                            <div
                                className="absolute top-full left-0 mt-3 w-80 bg-white dark:bg-[#222222] rounded-[14px] border border-[#dddddd] dark:border-[#3a3a3a] shadow-tier p-5 space-y-5 z-50">
